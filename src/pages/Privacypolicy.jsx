...
const Privacypolicy = () => {
  ...
  return (
   ...
   <div class=" container p-5">
    <div class=" conainer">
    <div class="row">
    <h1 class="mb-5 fw-bold">Privacy <span class="text-info"> Policy</span></h1>
...
<p>Privacy Policy created for Scholarship Academy by <a href="#">Scholarship Academy.</a></p>
    </div>
    </div>
   </div>
   <img class="w-100" src="https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/myProfileFooter_4e9fe2.png" alt=""/>
   </div>
    </>
  )
}
