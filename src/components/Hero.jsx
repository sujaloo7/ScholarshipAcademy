                ...
                <div className="container">
                    <div className="row p-4">
                        <div className="col-sm-6" data-aos={"fade-left"}>
                            <div className="copy">
                                ...
                                <div className="text-hero-regular">
                                    There are so many variations passages of management Your mindset about <br></br> bussiness in your company or agency
                                </div>
                                <div className="cta">
                                    <a href="#getstarted" className='but btn btn-primary shadow-none px-5'>Get Started</a>
                        ...
                        <div className="col-sm-6" data-aos={"fade-right"}>
                            <img src="https://growup-demo.netlify.app/assets/img/illustration/Hero%20Image.svg" height={400} className='w-100' alt="" />
                        </div>
                    </div>
                </div>
